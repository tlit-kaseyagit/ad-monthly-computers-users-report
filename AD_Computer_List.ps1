...
$OldComputers = Get-ADComputer -Filter * -properties cn,Enabled,LastLogonDate | select Name,Enabled,LastLogonDate | Where-Object {$_.LastLogonDate -lt $age -and $_.Enabled -eq "True"}
