...
$OldUsers = Get-ADuser -Filter * -properties Name, Enabled, LastLogonDate | select Name, Enabled, LastLogonDate | Where-Object { $_.LastLogonDate -lt $age -and $_.Enabled -eq "True"}
